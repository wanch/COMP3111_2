...
public class LoginDialog extends JFrame implements ActionListener
{
	...
	public LoginDialog()		// Create a dialog to log in
	{
		...
		signupPanel.add(new JLabel("Don't have an account ? Sign up here: "));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == button)
		{
			...
			if(LoginDialog.ValidString(username) && LoginDialog.ValidString(pw)) {
				...
				//else create user and the calendar grid
				...
				JOptionPane.showMessageDialog(null, "Username or Password has invalid character", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
