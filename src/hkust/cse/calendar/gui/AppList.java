...
class AppCellRenderer extends DefaultTableCellRenderer {
	...
	//appointment cell basic setting
	public AppCellRenderer(Object value, boolean override, int row, int col,
		...
		if (col == 2 || col == 5)
			setFont(font1);
		//appointment and status align left
		if (col != 0 && col != 3)
...
public class AppList extends JPanel implements ActionListener {
	...
	public AppList() {
		...
		JMenuItem menuItem;
		menuItem = (JMenuItem) pop.add(new JMenuItem("New"));
		...
		menuItem = (JMenuItem) pop.add(new JMenuItem("Delete"));
		...
		menuItem = (JMenuItem) pop.add(new JMenuItem("Modify"));
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				modify();
			}
